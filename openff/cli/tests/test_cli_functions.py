...
from openforcefield.utils import OPENEYE_AVAILABLE, RDKIT_AVAILABLE
...
class TestGenerateConformersCLI:
    ...
    def test_load_one_mol_sdf_without_charge(self, toolkit):
        ...
        mols_out = generate_conformers(
            molecule=ethanol, forcefield="openff-1.0.0.offxml", toolkit=toolkit
        )
    ...
    def test_load_multi_mol_sdf(self, toolkit):
        ...
        generate_conformers(
            molecule=butane_multi, forcefield="openff-1.0.0.offxml", toolkit=toolkit
        )
    ...
    def test_load_one_mol_smi(self, toolkit):
        ...
        mols_out = generate_conformers(
            molecule=ebastine, forcefield="openff-1.0.0.offxml", toolkit=toolkit
        )
    ...
    def test_load_multi_mol_smi(self, toolkit):
        ...
        mols_out = generate_conformers(
            molecule=dyes, forcefield="openff-1.0.0.offxml", toolkit=toolkit
        )
    ...
    def test_load_ambiguous_stereo_smi(self, toolkit):
        ...
        mols_out = generate_conformers(
            molecule=mol, forcefield="openff-1.0.0.offxml", toolkit=toolkit
        )
